...
void CGLWindow::draw_rectangle( const int x1, const int y1, const int x2, const int y2, const color4f & c )
{
	int x(std::min(x1, x2));
	int y(std::min(y1, y2));
	int width(abs(x1-x2));
...
void CGLWindow::fill_rectangle( const int x1, const int y1, const int x2, const int y2, const color4f & c )
{
	int x(std::min(x1, x2));
	int y(std::min(y1, y2));
	int width(abs(x1-x2));
