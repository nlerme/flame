...
class IWindow : public CScopeLogger
{
	...
	virtual void draw_rectangle( const int x1, const int y1, const int x2, const int y2, const color4f & c ) = 0;
	virtual void fill_rectangle( const int x1, const int y1, const int x2, const int y2, const color4f & c ) = 0;
